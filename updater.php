...
class WP_CLP_Updater {
	...
	public function __construct( $config = array() ) {
		...
		if ( ! $this->has_minimum_config() ) {
			$message = 'The CLP Updater was initialized without the minimum required configuration, please check the config in your plugin. The following params are missing: ';
